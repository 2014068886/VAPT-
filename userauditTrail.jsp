<%-- 
    Document   : userauditTrail
    Created on : Oct 25, 2017, 3:51:00 PM
    Author     : JMB
--%>
            ...
            <div class="col-sm-12 well">        
                ...
                <div class="pagination"> 
                    <c:if test="${pageNumber gt 1}">
                        <a href="userauditTrail.jsp?pageNumber=${pageNumber - 1}">Previous</a>
                    </c:if>

                    <c:forEach begin="1" end="${numberOfPages}" var="i">
                        <c:choose>
                            <c:when test="${i!=pageNumber}">
                                <a href="userauditTrail.jsp?pageNumber=<c:out value="${i}"/>"><c:out value="${i}"/></a>
                            </c:when>
                            <c:otherwise>
                    ...
                    <c:if test="${pageNumber lt numberOfPages}">
                        <a href="userauditTrail.jsp?pageNumber=${pageNumber + 1}">Next</a>
                    </c:if>
                </div>
            </div>
        </center>
